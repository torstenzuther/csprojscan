...
namespace CsprojScan.DependencyInjection
{
    ...
    public static class ScanMe
    {
        ...
        public static IServiceProvider Now(IEnumerable<string> basePaths, string exportFilename, string searchPattern = "*.csproj")
        {
            var serviceCollection = new ServiceCollection()
                                    .UseCsprojScan(basePaths, exportFilename, searchPattern);
